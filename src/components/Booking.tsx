          ...
          <div data-aos="fade-up">
            ...
            <div className="map-placeholder" style={{ height: "180px" }} aria-label="French Barber — 36 route du port, Lagnieu 01150">
              <div className="relative z-10 flex flex-col items-center gap-2 text-center px-4">
                ...
                <a href="https://maps.app.goo.gl/u2vVjvnwhrU4e5Te9" target="_blank" rel="noopener noreferrer" title="Itinéraire vers French Barber" className="btn-outline" style={{ fontSize: ".55rem", padding: ".5rem 1rem", marginTop: ".5rem" }}>
